...
namespace _08_Methods
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //    return "Buse Yıldız";
            //}
            //CustomerName();//bu yapının bir karşılığı yoktur.
            ...
            string ExamResalt(string student, int exam1, int exam2, int exam3)
            {
            ...
            Console.WriteLine(ExamResalt("Ali", 25, 41, 85));
            Console.WriteLine(ExamResalt("Ayşe", 36, 88, 33));
